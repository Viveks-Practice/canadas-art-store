...
// import autumnal_echoes_crisp_mountain_morn_1_img from "./images/Autumnal Echoes Crisp Mountain Morn/autumnal_echoes_crisp_mountain_morn_1.jpg";
// import autumnal_echoes_crisp_mountain_morn_2_img from "./images/Autumnal Echoes Crisp Mountain Morn/autumnal_echoes_crisp_mountain_morn_2.jpg";
// import autumnal_echoes_crisp_mountain_morn_3_img from "./images/Autumnal Echoes Crisp Mountain Morn/autumnal_echoes_crisp_mountain_morn_3.jpg";
// import autumnal_echoes_crisp_mountain_morn_4_img from "./images/Autumnal Echoes Crisp Mountain Morn/autumnal_echoes_crisp_mountain_morn_4.jpg";
// import autumnal_echoes_crisp_mountain_morn_5_img from "./images/Autumnal Echoes Crisp Mountain Morn/autumnal_echoes_crisp_mountain_morn_5.jpg";
// import autumnal_echoes_crisp_mountain_morn_6_img from "./images/Autumnal Echoes Crisp Mountain Morn/autumnal_echoes_crisp_mountain_morn_6.jpg";
// import autumnal_echoes_crisp_mountain_morn_7_img from "./images/Autumnal Echoes Crisp Mountain Morn/autumnal_echoes_crisp_mountain_morn_7.jpg";
// import majestic_horizon_autumns_radiant_glow_1_img from "./images/Majestic Horizon Autumns Radiant Glow/majestic_horizon_autumns_radiant_glow_1.jpg";
// import majestic_horizon_autumns_radiant_glow_2_img from "./images/Majestic Horizon Autumns Radiant Glow/majestic_horizon_autumns_radiant_glow_2.jpg";
// import majestic_horizon_autumns_radiant_glow_3_img from "./images/Majestic Horizon Autumns Radiant Glow/majestic_horizon_autumns_radiant_glow_3.jpg";
// import majestic_horizon_autumns_radiant_glow_4_img from "./images/Majestic Horizon Autumns Radiant Glow/majestic_horizon_autumns_radiant_glow_4.jpg";
// import majestic_horizon_autumns_radiant_glow_5_img from "./images/Majestic Horizon Autumns Radiant Glow/majestic_horizon_autumns_radiant_glow_5.jpg";
...
export const initialProducts = [
  ...
  //     images: [
  //       autumnal_echoes_crisp_mountain_morn_1_img,
  //       autumnal_echoes_crisp_mountain_morn_2_img,
  //       autumnal_echoes_crisp_mountain_morn_3_img,
  //       autumnal_echoes_crisp_mountain_morn_4_img,
  //       autumnal_echoes_crisp_mountain_morn_5_img,
  //       autumnal_echoes_crisp_mountain_morn_6_img,
  //       autumnal_echoes_crisp_mountain_morn_7_img,
  //     ],
  //     details:
  //       'Medium: Oil on canvas\nDimensions: 48" x 30" (122cm x 76cm)\nFrame: Decorative white frame that complements the vivid colors of the painting\nTechnique: The artist has employed a range of brushstrokes to capture the texture of the foliage and the ruggedness of the mountains\nPalette: A rich array of autumn colors, from deep reds to golden yellows, set against the cool blues and whites of the mountains and sky\nSigned by the artist in the lower right corner\nYear of Creation: 2024\nCare Instructions: To maintain the vibrancy of the colors, avoid placing in direct sunlight. Clean with a soft, dry cloth.',
  //     reviews: [],
  //   },
  //   {
  //     id: 11,
  ...
  //     images: [
  //       majestic_horizon_autumns_radiant_glow_1_img,
  //       majestic_horizon_autumns_radiant_glow_2_img,
  //       majestic_horizon_autumns_radiant_glow_3_img,
  //       majestic_horizon_autumns_radiant_glow_4_img,
  //       majestic_horizon_autumns_radiant_glow_5_img,
  //       majestic_horizon_autumns_radiant_glow_6_img,
  //       majestic_horizon_autumns_radiant_glow_7_img,
  //       majestic_horizon_autumns_radiant_glow_8_img,
  //     ],
  //     details:
